...
import com.github.akinaru.bleanalyzer.chart.DataAxisFormatter;
...
public class AnalyzerActivity extends BaseActivity implements IADListener, IScheduledMeasureListener, IBtActivity {
    ...
    private TextView bluetoothRssi = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btDevice = new BluetoothObject(deviceAddr, deviceName, adInterval, deviceRssi);
        ...
        bluetoothRssi =  (TextView) findViewById(R.id.Rssi_value);
    ...
    @Override
    public void onADframeReceived(final long time, final List<Long> history, final int rssi) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                bluetoothRssi.setText("" +rssi);
                Log.i("Rssi " , " Rssi" +btDevice.getDeviceRssi());
            }
        });
    }
